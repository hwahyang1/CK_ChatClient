...
<template>
      ...
      <div class="bg-white">
        ...
        <div class="messages-box">
          <div class="list-group rounded-0">
            ...
            <UserElement userName="UserName" message="message" timestamp="Aug 25"></UserElement>
    ...
    <div class="col-7 px-0">
      ...
      <!-- Typing area -->
      <form @submit.prevent="" ref="messageform" class="bg-light">
        <div class="input-group">
          <input type="text" placeholder="Type a message" aria-describedby="button-addon2" class="form-control rounded-0 border-0 py-4 bg-light Pretendard-Regular">
